...
public class ProductService {
	...
	private static final Map<Integer, Double> productPrice = new HashMap<Integer, Double>();
	static {
		productPrice.put(31, (double) 15);
		productPrice.put(45, (double) 30);
		productPrice.put(50, (double) 40);
	}
	private static final Map<Integer, Integer> productQuantity = new HashMap<Integer, Integer>();
	static {
